...
import { createUser, findOrCreateUser, findUser, findUserById } from "./user";
...
export const usePassportLocal = (params) => {
  return new Promise(async (resolve, reject) => {
    console.warn("RUNNING: Local passport strategies");
    try {
      ...
      // await passport.serializeUser(function(user, cb) {
      //   cb(null, user.id);
      // });
      
      // await passport.deserializeUser(function(id, cb) {
